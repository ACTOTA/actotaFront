  ...
  return (
    <div className="flex flex-wrap">
      {towns.map((town, index) => (
        <div key={index} className="flex items-center m-2 mt-5 space-x-4 transition duration-200 ease-out transform cursor-pointer rounded-xl hover:bg-gray-100 hover:scale-105"> 
